...
## Project Structure
    ...
    ├── shzb_final_screens__40745  # Django project configurations
...
1. Clone this repo and `cd shzb_final_screens__40745`
...
2. Clone this repo and `cd shzb_final_screens__40745`
