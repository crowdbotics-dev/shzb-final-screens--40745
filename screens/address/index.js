...
const AddressScreen = ({
  ...
  return <ScrollView style={[styles.container]} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.searchContainer}>
        ...
        <View style={[styles.inputText, styles.KWYjfcow]}>
          <View style={styles.NFoZeQVy}>
